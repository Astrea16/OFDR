...
const headerLogo = document.querySelector(".header__logo"), interval =750;

let str = headerLogo.textContent;

function repeat() {
	for (let e = 0; e < str.length; e++)
		headerLogo.innerHTML = str,
			setTimeout((function () {
				let t = '<span class = "header__span">' + str.substring(0, e + 1) + '</span>' + str.substring(e + 1);
				headerLogo.innerHTML = t
			}), 750 * e);
	setTimeout(repeat, 750 * str.length)
}
repeat();
...
let sliderPrograms = new Swiper('.slider-programs__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.slider-programs__pagination',
		clickable: true,
	},
	breakpoints: {
		320: {
...
let sliderExample = new Swiper('.slider-example__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-example__arrow--next',
		prevEl: '.slider-example__arrow--prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
